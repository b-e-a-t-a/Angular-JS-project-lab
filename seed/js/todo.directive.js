      ...
      <div class="todo">
        ...
        <ul class="todo__list">
          <li ng-repeat="item in todo.list">
            ...
            <!-- when we double click on an element we can then hide <p> revealing the input
              and allow user to change it and once they tab out of the input we can then
              save the todo item, hide the input and display the updated <p> -->
